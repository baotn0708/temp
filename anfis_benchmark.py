...
from anfis_only_core import ANFISConfig, benchmark_single_dataset, resolve_datasets
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Clean ANFIS-only benchmark for AMZN/JPM/TSLA with chronological 7/3 or 7/2/1 splits."
    )
    ...
    parser.add_argument("--output-dir", type=str, default="./anfis_benchmark_outputs")
...
def main() -> None:
    ...
    for dataset_name, path in datasets:
        ...
        report_lines = [
            f"# ANFIS-only benchmark: {dataset_name}",
            "",
            "## Protocol",
